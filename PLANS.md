...
- Continue improving paged-memory slow paths, especially cross-page accesses and richer fault reporting; committed-page ITLB/DTLB hits, primitive page-table lookup, and VMA access protections are now in place.
