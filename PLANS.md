...
- Continue profiling block-boundary and trace-formation overhead beyond one stable self-loop block; avoid broad direct-call caches unless benchmarks show a clear win.
