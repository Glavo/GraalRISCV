...
- Filesystem metadata now includes guest-visible uid, gid, and chmod mode bits for host and tar mounts, with Linux-style owner/group/other DAC and ancestor-directory search checks for access, open, metadata, directory mutation, truncate, chdir, chmod, and chown paths.
