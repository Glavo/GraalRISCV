...
- Filesystem metadata now includes guest-visible uid, gid, and chmod mode bits for host and tar mounts, with Linux-style owner/group/other DAC checks for access, open, directory mutation, truncate, chdir, chmod, and chown paths.
