...
- Continue adding broader static Linux acceptance examples beyond the current pthread join and runtime-services smoke
  checks as syscall and ELF coverage grows.
